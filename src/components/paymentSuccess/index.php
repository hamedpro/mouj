...
<script src="../common/svgs.js"></script>
    ...
    <div id="payment-success" className="content-container">
        <div className="row justify-content-center d-flex mt-3">
            <div className="col-8">
            <h1 className="text-success" dir="rtl" style="text-align:center;">پرداخت شما با موفقیت انجام شد</h1> 
            </div>
        </div>
        <div className="row justify-content-center d-flex mt-1">
            <div className="col-10">
                <h5 className="text-secondary" dir="rtl" style="text-align:center;">اطلاعات پرداخت شما به شرح زیر است :</h5>
            </div>
        </div>
        <div className="row mx-2 mt-4" dir="rtl">
            ...
            <div className="col">
                <h2 className="text-warning" dir="rtl" id="username"><?php echo $username ?></h2>
            </div>
        </div>
        <div className="row mx-2" dir="rtl">
            ...
            <div className="col">
                <h2 className="text-warning" dir="rtl" id="amount"><?php echo $amount ?></h2>
            </div>
        </div>
        <div className="row mx-2" dir="rtl">
            <div className="col-4">
            ...
            <div className="col">
                <h2 className="text-warning" dir="rtl" id="info"><?php echo $plan_id ?></h2>
            </div>
        </div>
        <div className="row mx-2" dir="rtl">
            <div className="col-4">
            ...
            <div className="col">
                <h2 className="text-warning" dir="rtl" id="category"><?php echo $category=="mouj"? 'طرح موج':'موسسه آنسه الشهدا' ?></h2>
            </div>
        </div>
