        ...
        return (
            <div className='home content-container'>
                <div className="home-option row">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" className="bi bi-tornado option-icon" viewBox="0 0 16 16">
                ...
                <div className="home-option row">
                    <div className="col-3 d-flex justify-content-center align-items-center m-r-1-percent">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" className="bi bi-pie-chart option-icon" viewBox="0 0 16 16">
                ...
                <div className="home-option row">
                    <div className="col-3 d-flex justify-content-center align-items-center m-r-1-percent">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" className="option-icon bi bi-envelope" viewBox="0 0 16 16">
