        ...
        return (
            <div className="timelineBox">
                <div className="timelineIcon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray" className="bi bi-tsunami" viewBox="0 0 16 16">
                ...
                <h6 className="timelineTitle text-secondary">${this.props.title}</h6>
                <div className="timelineLine"></div>
                <div className="timelineItemsContainer"></div>
