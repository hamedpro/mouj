<template>
    ...
    <homeOption
        ...
        link="#/new"
        image_src="bootstrap-icons/tornado-white.svg"
    ></homeOption>
    <hr>
    <homeOption
        ...
        link="#/charts"
        image_src="bootstrap-icons/pie-chart-white.svg"
    ></homeOption>
    <hr>
    <homeOption
        title="پشتیبانی"
        ...
        link="#/support"
        image_src="bootstrap-icons/envelope-white.svg"
    ></homeOption>
    <hr>
...
<script>
import homeOption from './home-option.vue'
export default {
    name:"home",
    components:{
        homeOption
